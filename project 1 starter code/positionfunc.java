...
public abstract class positionfunc extends Octo
{
    public positionfunc(String id, Point position, List<PImage> images, int resourceLimit, int resourceCount, int actionPeriod, int animationPeriod) {
