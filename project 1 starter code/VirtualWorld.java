   ...
   extends PApplet
{
   ...
   public static final String IMAGE_LIST_FILE_NAME = "project 1 starter code/imagelist";
   public static final String DEFAULT_IMAGE_NAME = "background_default";
   public static final int DEFAULT_IMAGE_COLOR = 0x808080;

   public static final String LOAD_FILE_NAME = "project 1 starter code/world.sav";
   ...
   */
      ...
      EventScheduler scheduler, ImageStore imageStore)
   {
      for (Entity entity : world.getEntities())
      {
         ...
         if (entity.getaction() > 0 && entity instanceof Sched_Acti)
            ((Sched_Acti)entity).scheduleActions(scheduler, world, imageStore);
      }
   }
